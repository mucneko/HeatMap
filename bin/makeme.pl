...
my @indatum = split('_', $datum);
my $aktYear = shift @indatum;
my $lastYear = $aktYear - 1;
...
my $call1 = "./createHeatmap.pl -c $configFile -o MUC -w $kw -f HeatMap_MUC_$datum\_$kw\_neu $dataBase/$MUC_DATA{$lastYear}/Data.csv $dataBase/$MUC/Data.csv" ;
my $call2 = "./createHeatmap.pl -c $configFile -o GER -w $kw -f HeatMap_GER_$datum\_$kw\_neu $dataBase/$GER_DATA{$lastYear}/Data.csv $dataBase/$GER/Data.csv" ;
