...
my $call1 = "./createHeatmap.pl -c $configFile -o MUC -w $kw -f HeatMap_MUC_$datum\.gif ../../../$MUC_2021/Data.csv ../../../$MUC/Data.csv" ;
my $call2 = "./createHeatmap.pl -c $configFile -o GER -w $kw -f HeatMap_GER_$datum\.gif ../../../$GER_2021/Data.csv ../../../$GER/Data.csv" ;
