...
Scenario: get anzahl data for Muenchen from survstat.rki.de
...
Then make BrowserPicture and save it as "get_csv_MUC_anzahl_0.png"
...
Then make BrowserPicture and save it as "get_csv_MUC_anzahl_1.png"
